...
const copy = {
  fr: {
    quote: {
      ...
      questions: "Une question ? Répondez à cet e-mail ou écrivez-nous à contact@tmrix.com",
  ...
  en: {
    quote: {
      ...
      questions: "Questions? Reply to this email or contact us at contact@tmrix.com",
